...
export default function Slogan() {
  ...
  const baseClassName = "whitespace-nowrap will-change-transform text-[48px] md:text-[72px] lg:text-[96px] font-aggravo font-[550] leading-[120%] tracking-[-2.88px] text-center";
  const weAreClassName = "text-[32px] md:text-[48px] lg:text-[64px] font-aggravo font-[550] leading-[120%] tracking-[-1.92px] text-center text-[#EEE]";
  const fashionClassName = "text-[48px] md:text-[72px] lg:text-[90px] font-aggravo font-[550] leading-[120%] tracking-[-2.7px] text-center text-[#9747FF]";
